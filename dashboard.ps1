$Dashboard = New-UDDashboard -Title "PowerShell Universal Dashboard Clock" -Content {
    ...
    New-UDColumn -Endpoint {
        while($true) {
            ...
            Set-UDElement -Id "seconds" -Attributes @{ x1 = '100'; y1 = '100'; x2 = $x; y2 = $y; style = @{ strokeWidth = '6px'; stroke = 'green'; }}
            ...
            Set-UDElement -Id "minutes" -Attributes @{ x1 = '100'; y1 = '100'; x2 = $x; y2 = $y; style = @{ strokeWidth = '4px'; stroke = 'blue'; }}
            ...
            Set-UDElement -Id "hours" -Attributes @{ x1 = '100'; y1 = '100'; x2 = $x; y2 = $y; style = @{ strokeWidth = '2px'; stroke = 'red'; }}
